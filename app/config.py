...
class Settings:
    ...
    concurrency: int = int(os.getenv("MYNTRA_CONCURRENCY", "3"))
    request_delay: float = float(os.getenv("MYNTRA_REQUEST_DELAY", "0.05"))
    jitter: float = float(os.getenv("MYNTRA_JITTER", "0.15"))
